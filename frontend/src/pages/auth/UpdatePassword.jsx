...
export default function SignUp() {
  ...
  return (
    <main className="w-full min-h-screen grid lg:grid-cols-[1fr_32rem] text-gray-700">
      <AuthContent title="Choose new password">
        <UpdatePasswordForm />
        <div className="mt-6">
          <Link to="/dashboard/settings" className="inline-flex items-center text-sm font-medium text-violet-500 hover:text-violet-700 transition-colors">
