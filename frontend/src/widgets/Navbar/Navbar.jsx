    ...
    <header className="fixed top-0 left-0 right-0 z-[500] w-full bg-transparent">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center h-24">
          ...
          <button onClick={() => setMobileOpen((s) => !s)} aria-expanded={mobileOpen} aria-label="Open main menu" className="ml-auto xl:hidden relative z-[60] rounded-full flex-none flex items-center justify-center w-10 h-10 transition-colors rounded-full bg-white/75 bg-gradient-to-r from-pink-200/40 via-violet-200/40 to-indigo-200/40 border border-white/50 px-2 text-sm shadow-lg hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-violet-300">
            {/* icon */}
