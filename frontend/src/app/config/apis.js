...
export const classroomEndpoints = {
  ...
  CREATE_ANNOUNCEMENT_API: BASE_URL + "/classroom",
  LIST_ANNOUNCEMENTS_API: BASE_URL + "/classroom",
  CREATE_TOPIC_API: BASE_URL + "/classroom",
  LIST_TOPICS_API: BASE_URL + "/classroom",
  CREATE_ASSIGNMENT_API: BASE_URL + "/classroom/topics",
  LIST_ASSIGNMENTS_BY_TOPIC_API: BASE_URL + "/classroom/topics",
  SUBMIT_ASSIGNMENT_API: BASE_URL + "classroom/assignments",
  GET_SUBMISSIONS_API: BASE_URL + "classroom/assignments",
  GRADE_SUBMISSION_API: BASE_URL + "classroom/submissions",
};