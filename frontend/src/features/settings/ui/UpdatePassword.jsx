  ...
  return (
    <>
      <form onSubmit={handleSubmit(submitPasswordForm)}>
        <div className="my-10 flex flex-col gap-y-6 rounded-md border-[1px] border-black  p-8 px-6 sm:px-12">
        ...
        <div className="flex justify-end gap-2">
          <button
            ...
            className="cursor-pointer rounded-md  py-2 px-5 font-semibold text-black"
          >
            Cancel
          </button>
