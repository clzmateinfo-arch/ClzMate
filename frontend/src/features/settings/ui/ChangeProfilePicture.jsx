...
export default function ChangeProfilePicture() {
  ...
  return (
    <>
      <div className="flex items-center justify-between rounded-md border-[1px] border-black  p-8 px-3 sm:px-12 text-black">
          ...
          <div className="space-y-2">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <button
                onClick={handleClick}
                disabled={loading}
                className="cursor-pointer rounded-md py-2 px-5 font-semibold  text-black hover: hover:text-black duration-300"
              >
                Select
              </button>
